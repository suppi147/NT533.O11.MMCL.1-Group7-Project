...
<html lang="en">
    <head>
        ...
        <link href="/route1/Noteziee/CommentUI/css/index.css" rel="stylesheet" />
        <link href="/route1/Noteziee/CommentUI/css/checkbox.css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="/route1/Noteziee/Homepage/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="/route1/Noteziee/Homepage/assets/css/fontawsom-all.min.css">
    <link rel="stylesheet" href="/route1/Noteziee/Homepage/assets/css/button.css">
    <link rel="stylesheet" href="/route1/Noteziee/Homepage/assets/plugins/owl/owl.carousel.min.css">
      <link rel="stylesheet" href="/route1/Noteziee/Homepage/assets/plugins/owl/owl.theme.css">
    <link rel="stylesheet" type="text/css" href="/route1/Noteziee/Homepage/assets/css/style.css" />
    ...
    <header id="menu-jk" class="container-fluid">
          <div class="container">
              <div class="row">
                   ...
                   <div id="menu" class="col-lg-9 d-none d-lg-block navigation">
                       <ul>
                           <li><a href="http://localhost/route1/Noteziee/Homepage">Home</a></li>
      ...
      <div class="container">
      <form action="http://localhost/route1/Noteziee/MainController/MainRail.php" name="submitForm" method="POST" id="commentID" onclick="ReceiveEnter();">
...
echo '</div>
       ...
       <div class="container">
           ...
           <div class="footer-copy">
            ...
            <script src="/route1/Noteziee/Homepage/assets/js/jquery-3.2.1.min.js"></script>
            <script src="/route1/Noteziee/Homepage/assets/js/popper.min.js"></script>
            <script src="/route1/Noteziee/Homepage/assets/js/bootstrap.min.js"></script>
            <script src="/route1/Noteziee/Homepage/assets/plugins/owl/owl.carousel.min.js"></script>
            <script src="/route1/Noteziee/Homepage/assets/plugins/scroll-fixed/jquery-scrolltofixed-min.js"></script>
            <script src="/route1/Noteziee/Homepage/assets/js/script.js"></script>
                </html>';
?>